...
# 2. إنشاء وتثبيت النسخة المطلوبة (v9.1 ULTIMATE)
...
while true; do
    ...
    echo -e "${C_PRP}│${C_NC}   ${C_WHT}$DOMAIN${C_NC}"
    ...
    echo -e "${C_PRP}└─────────────────────────────────────────────────────────────┘${C_NC}"
    echo -e "${C_PRP}┌─────────────────────────────────────────────────────────────┐${C_NC}"
    echo -e "${C_PRP}│${C_NC}  ${C_CYN}[1]${C_NC} 🚀 Install & Auto-Open All Ports (SSL/80/53/Proxy)  ${C_PRP}│${C_NC}"
...
clear
echo -e "\033[1;32m[ ✔ ] Successfully wiped old versions and installed K3ko Manager v9.1 ULTIMATE!\033[0m"
